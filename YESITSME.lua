...
local Window = Kavo:CreateWindow({
    Title = "HamzHub",
    Subtitle = "HamzHub Is Loading",
    Theme = Kavo.Themes.DarkTheme
})
...
MainTab:CreateToggle("BLATI (Instant Fishing)", false, function(Value)
    getgenv().Blati = Value
    if Value then
        startBlati()
        local args = {
...
MainTab:CreateToggle("FORCE SECRET (Instant Fishing Secret)", false, function(Value)
...
PlayerTab:CreateTextbox("WalkSpeed", "16", function(Text)
...
PlayerTab:CreateTextbox("Sell Every (min)", "3", function(Text)
...
PlayerTab:CreateToggle("AUTO SELL", false, function(Value)
...
TeleportTab:CreateButton("Pulau Kinyis", function()
...
TeleportTab:CreateButton("Pulau Raja Ampat", function()
    local hrp = player.Character and player.Character:FindFirstChild("HumanoidRootPart")
    if hrp then
...
TeleportTab:CreateButton("Pulau Wakatobi", function()
    local hrp = player.Character and player.Character:FindFirstChild("HumanoidRootPart")
    if hrp then
...
TeleportTab:CreateButton("Pulau Bali", function()
    local hrp = player.Character and player.Character:FindFirstChild("HumanoidRootPart")
    if hrp then
...
TeleportTab:CreateButton("Pulau natuna", function()
    local hrp = player.Character and player.Character:FindFirstChild("HumanoidRootPart")
    if hrp then
